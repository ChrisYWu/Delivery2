USE [Merch]
GO
/****** Object:  StoredProcedure [Operation].[pGetMerchStoreDelivery]    Script Date: 12/5/2018 11:02:08 AM ******/
SET ANSI_NULLS ON
GO
...
/*
-- Problem is invoice item split, see below query
Select DeliveryDateUTC, SAPAccountNumber, ItemNumber, Count(*) Cnt, Sum(Quantity) Quantity
From Mesh.CustomerInvoice ci
Join Mesh.InvoiceItem ii on ci.RMInvoiceID = ii.RMInvoiceID
Where SAPAccountNumber in (12269913)	
And ci.DeliveryDateUTC = '2018-12-05'
